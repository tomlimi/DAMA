    ...
    **kwargs: Any,
    ...
    for request in requests:
        if hparams.update_strategy == "random":
            request["target_new"]["str"] = np.random.choice(list(LLAMA_PRONOUNS.values()))
        elif hparams.update_strategy == "neutral":
            request["target_new"]["str"] = LLAMA_PRONOUNS["neut"]
        elif hparams.update_strategy == "opposite":
            request["target_new"]["str"] = request["target_new"]["str"]
        else:
            request["target_new"]["str"] = None
    ...
    for it in range(hparams.num_steps):
        ...
        for txt, tgt in zip(
            ...
            # hack for fast tokenizer
            #inputs["decoder_input_ids"] = inputs.input_ids
            del inputs.data["token_type_ids"]
            ...
            # print(loss_mask)
            # print(target_ids)
            # print(torch.gather(probs, 1,target_ids))
