...
#SBATCH -o /home/limisiewicz/my-luster/dama/job_output/eval-memit.out
...
for ds in "${ds_prefix[@]}"
do
  python evaluate_model.py --param_number 7 --method "MEMIT" --test_file "${ds}_${ds_split}.txt" --test_task "coref"
done